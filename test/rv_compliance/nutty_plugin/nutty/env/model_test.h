...
#define DMEM_LENGTH 0x00200000
#define TESTUTIL_BASE (BASE_ADDR + DMEM_LENGTH - 12)
...
// https://github.com/riscv-non-isa/riscv-arch-test/blob/main/spec/TestFormatSpec.adoc
